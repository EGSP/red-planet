...
public readonly struct Obb
{
    ...
    /// <summary>
    /// Ближайшая к точке точка прямоугольника. Для точки внутри возвращается она сама,
    /// потому что ближе прямоугольник к ней не подходит.
    ///
    /// Считается в собственных координатах прямоугольника: повёрнутый там снова
    /// осепараллелен, и весь расчёт сводится к ограничению координат половинными размерами.
    /// </summary>
