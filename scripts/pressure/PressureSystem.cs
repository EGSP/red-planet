...
/// вырожденная тактика.
///
/// ВОЛНЫ БЮДЖЕТОМ НЕ ОГРАНИЧЕНЫ и живут отдельной системой — <see cref="WaveSystem"/>.
/// Их юниты отмечены признаком <see cref="PressureOrigin.Wave"/> и в занятое место не входят:
/// волна есть напряжение в моменте, а не часть фона. Фон при этом на время волны
