...
public static class ContentValueReader
{
    ...
    public static object Tool(ToolDefinition tool, ContentFieldSpec field)
    {
        ...
        return field.Key switch
        {
            ...
            "splash_radius" => (tool as WeaponDefinition)?.SplashRadius,
            "splash_damage" => (tool as WeaponDefinition)?.SplashDamage,
            "splash_friendly_fire" => (tool as WeaponDefinition)?.SplashFriendlyFire,
