...
/// время и по разным событиям. План — по щелчку игрока, каркас — когда исполнитель дошёл
...
/// Во-вторых, событие бывает не только у снаряда, и все они выражаются одним документом.
