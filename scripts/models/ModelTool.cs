...
public partial class ModelTool : Node2D
{
    ...
    ///
    /// ЛУЧ ОСТАЛСЯ УЗЛОМ, в отличие от точки вылета и объявлений эффектов: он держит
    /// собственное состояние — точку конца и разгорание, — то есть в игре работает,
    /// а не хранит значение. Изображение при этом рисует не он, а <see cref="BeamSystem"/>.
    ///
