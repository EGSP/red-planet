...
public partial class DebugPanel : ToolPanel
{
    ...
    private void FillConstruction(Node box)
    {
        Section(box, "Стройка",
            ...
            "готовности: ниже уровня корпус виден как есть, выше — сеткой одного цвета, а по " +
            "уровню идёт полоса фронта. Приём взят из Planetary Annihilation. Каркас, к " +
            "которому никто не подключён, рисуется тем же шейдером неподвижно.");
        ...
        Slide(box, "плотность готового", 0f, 1f, 0.01f,
            "Непрозрачность уже построенной части. Единица показывает корпус как есть.",
