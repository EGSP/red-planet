...
public partial class CloudRenderer : Node2D
{
    ...
    /// у поверхности: редактор сохраняет содержимое свойств, а в материале лежит карта
    ...
    /// <summary>
    /// Завести материал, если его нет. Он создаётся заново при каждой загрузке и в сцене
    ...
    /// <summary>Снять материал и карту плотности: после этого узлу нечего отдать сохранению.</summary>
    private void Detach()
    {
        Material = null;
        _material = null;
