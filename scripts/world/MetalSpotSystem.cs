...
///
/// ПОЧЕМУ ЭТО СИСТЕМА, А НЕ ВЫЗОВ ИЗ СЕССИИ. Расставлять точки можно только по собранному
/// миру, иначе они встанут под тем, что выдано на старте. Стартовую раздачу делает Session
