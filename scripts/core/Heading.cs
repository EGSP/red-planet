...
/// Подвижные сущности реализуют его прямо через Rotation ноды — тогда и отрисовка,
/// и ToLocal считаются движком сами. Здания ноду не крутят: их визуал привязан к сетке,
/// поэтому ось у них живёт отдельным числом и рисуется маркером.
/// </summary>
