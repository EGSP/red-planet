...
/// достройка каркаса, постановка каркаса, спавн руды и коммандер.
...
public sealed class Spawner
{
    ...
    /// Угол не задан — берётся из справочника: так появлялись бы постройки, которых никто
    /// не ставил. Сейчас все они приходят из достройки каркаса и угол несут свой.
    /// </summary>
    public Building SpawnBuilding(UnitDefinition def, Vector2 center, float? facing = null)
    {
        ...
        // Факт «постройка есть в мире» публикуем здесь, а не в каркасе: ёмкость хранилища
        // зависит от наличия постройки, а не от того, была ли она построена игроком
